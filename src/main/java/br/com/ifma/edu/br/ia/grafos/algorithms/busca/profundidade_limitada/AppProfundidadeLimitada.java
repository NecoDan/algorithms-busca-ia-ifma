package br.com.ifma.edu.br.ia.grafos.algorithms.busca.profundidade_limitada;

import br.com.ifma.edu.br.ia.grafos.algorithms.busca.profundidade_limitada.busca.DepthLimitedSearch;

import java.util.InputMismatchException;
import java.util.Scanner;

public final class AppProfundidadeLimitada {

    private AppProfundidadeLimitada() {

    }

    public static void executaTesteBuscaEmProfundidadeLimitada() {
